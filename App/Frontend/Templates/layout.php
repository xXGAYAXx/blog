  ...
  <body>
    ...
    <header>
      ...
      <div id="nav-box"><!-- /////////////////////////// NAV-BOX /////////////////////////// -->
        ...
        <nav><!-- NAV -->
          <ul id="nav-list-box">
            <li class="nav-list menu-list nav-title"><a href="/" title="Lien vers la page Accueil">L'élu de l'Adméria</a></li>
            <li class="nav-list menu-list"><a href="/" title="Lien vers la page Accueil">Accueil</a></li>
            <li class="nav-list menu-list"><a href="/chapter-list" title="Lien vers la page Liste des chapitres">Chapitres</a></li>
            <li class="nav-list menu-list"><a href="/last-chapter" title="Lien vers la page Dernier chapitre">Dernier chapitre</a></li>
    ...
    <footer>
      <div class="row">
        ...
        <div class="footerList col-md-3 col-lg-3 col-sm-3">Réalisé par <a target="_blank" href="http://www.adn.thais-kevin.club">ADN</a> </div>
    		...
    		<div class="footerList col-md-3 col-lg-3 col-sm-3"><a href="/admin/" title="Lien vers la page Administration">Administration</a></div>
      </div>
